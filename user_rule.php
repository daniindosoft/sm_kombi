  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Ketentuan & Rule Yang Harus di Ketahui</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
<script type="text/javascript">
  document.title = "KOMBI | Ketentuan & Rule <?php echo $komunitas['nama_komunitas'] ?>";
        var menuaddclass = document.getElementById("infos");
    menuaddclass.classList.add("active");

        var menuaddclassx = document.getElementById("rule");
