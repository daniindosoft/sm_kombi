  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-3">
            <a href="<?php echo $onMy->primaryLocal; ?>user/post" class="btn btn-warning btn-block mb-3">Buat Post</a>
              ...
              <div class="card card-widget collapsed-card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    ...
                    <?php if ($_GET['status'] == 'draft'): ?>
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
                      <a href="#" onclick="return redirect('<?php echo $onMy->primaryLocal ?>user/post/edit?id=<?php echo $value['id'] ?>')" class="float-right"><i class="fa fa-pencil-alt"></i> Edit</a>
                    </button>
                    <?php endif ?>
                    <button type="button" class="btn btn-tool" data-card-widget="collapse">
