  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <a href="<?php echo $onMy->primaryLocal ?>user/faq">
          <div class="info-box">
      ...
      <!-- /.col -->
      <div class="col-md-3 col-sm-6 col-12">
        <a href="<?php echo $onMy->primaryLocal ?>admin/post">
          <div class="info-box">
      ...
      ?>
        <div class="card card-widget yellow-border">
          ...
          <div class="card-body">
            <?php echo $value['text'] ?>
            <hr>
            <button onclick="return share('<?php echo $onMy->primaryLocal ?>public/post?id=<?php echo $value['id'] ?>')" type="button" class="btn btn-default btn-sm"><i class="fas fa-share"></i> Share</button>
            <?php 
              $class = '';
              $disable = '';
                ...
                <div class="card-comment">
                  ...
                  <div class="comment-text">
                    <span class="username">
                      ...
                      <?php else: ?>
                        <?php 
                          if ($val['type_user'] == 'admin') {
                            echo '<i class="far fa-check-circle fa-sm text-primary" title="Admin"></i> ';
                          }
                          echo $val['nama_lengkap'];
                        ?>
                      <?php endif; ?>
