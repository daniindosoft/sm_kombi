  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <a href="<?php echo $onMy->primaryLocal ?>admin/pengaturan">
          <div class="info-box">
            <span class="info-box-icon bg-info"><i class="fa fa-user-cog"></i></span>
            <div class="info-box-content">
              <h4 class="info-box-text">Pengaturan</h4>
            </div>
          </div>
        </a>
        <!-- /.info-box -->
      ...
      <!-- /.col -->
      <div class="col-md-3 col-sm-6 col-12">
        <a href="<?php echo $onMy->primaryLocal ?>admin/bisnis/affiliate">
          <div class="info-box">
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <a href="<?php echo $onMy->primaryLocal ?>admin/post">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <h4 class="info-box-text">Laporan</h4>
            </div>
          </div>
        </a>
      </div>
      <!-- /.col -->
      <div class="col-md-3 col-sm-6 col-12">
        <a href="<?php echo $onMy->primaryLocal ?>admin/bisnis/pengajuan_komisi">
          <div class="info-box">
