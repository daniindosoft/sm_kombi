        ...
        <div class="card-body pb-0">
          <div class="row">
            ...
            <?php 
              ...
              $postPaginate = $onMy->tampil_manual(' select *, k.id as idk, u.id as idu from users as u join komunitas as k on k.id_user = u.id where k.id_komunitas = '.$_SESSION['bisnis_kategori_combi'].' '.$cari.' and k.status =1 order by u.nama_lengkap asc limit '.$halaman_awal.', '.$batas);
              
              $nomor = $halaman_awal+1;

              
              foreach ($postPaginate as $val): 
                $dataAffiliate = $onMy->getDataAffiliate($val['idu'], $_SESSION['bisnis_kategori_combi']);
              ...
              <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
                <div class="card bg-light d-flex flex-fill">
                  ...
                  <div class="card-footer">
                      ...
                      <div class="row">
                        <?php 
                          $cssSingle = 'col-md-12 col-12';
                          if ($val['is_private'] != '1'){
                            $cssSingle = 'col-md-4 col-4';
                          }
                        ?>
                        <div class="<?php echo $cssSingle ?> border-right">
                    ...
                    <div class="text-right">
                      ...
                      <a href="<?php echo $onMy->primaryLocal ?>view/user?u=<?php echo $val['username'] ?>" class="btn btn-sm btn-warning btn-block">
