...
?>
              ...
              <div class="card-body p-0">
                <ul class="nav nav-pills flex-column">
                  ...
                  <li class="nav-item" id="jumlah-periksa">
                    <a href="<?php echo $onMy->primaryLocal ?>admin/post/check" class="nav-link">
              ...
              <div class="card card-success card-outline">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <input class="form-control" placeholder="Judul Post" name="judul" required value="<?php echo $getData['judul'] ?>" maxlength="70">
                  </div>
                  <div class="form-group">
  ...
  <script>
    document.title = "KOMBI | Edit Post <?php echo $namaKomunitas ?>";
