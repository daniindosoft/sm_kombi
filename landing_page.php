  ...
  <body>
    <main>
      ...
      <div class="px-4 py-4 my-5 text-center">
        <div class="warning-notted" style="background-color:white;">
          <h3>🎊 Promo Launching </h3>
        </div>
        <br>
        <br>
      ...
      <div class="px-4 pt-5 my-5 text-center border-bottom">
        ...
        <div class="col-lg-6 mx-auto">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">
              <h5><i class="fa fa-check-circle text-warning"></i> Tidak bergantung pada platform sosial media</h5>
            </li>
            <li class="list-group-item">
              <h5><i class="fa fa-check-circle text-warning"></i> Mudah melakukan Upselling/Cross Selling</h5>
            </li>
            <li class="list-group-item">
      ...
      <div class="px-4 pt-5 my-5 text-center border-bottom">
        ...
        <div class="overflow-hidden" style="max-height: 30vh;">
          <div class="container px-5">
            <img src="https://duniaundercover.files.wordpress.com/2023/03/4782264.jpg" class="img-fluid border rounded-3 shadow-lg mb-4" alt="Example image" width="700" height="500" loading="lazy">
          </div>
        </div>
        <br>
        <br>
          ...
          <div class="col-lg-8">
            ...
            <div class="bd-example-snippet bd-code-snippet">
              <div class="bd-example">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    <h5>🤑 Ingin <b class="text-warning">punya kolam uang</b> yang kerja sendiri ? <small class="text-sm">&nbsp;&nbsp;&nbsp;Ya</small></h5>
                  </li>
                  <li class="list-group-item">
                    <h5>🤫 Ingin punya bisnis dengan sistem <b class="text-warning">Semi Auto Pilot </b>? <small class="text-sm">&nbsp;&nbsp;&nbsp;Ya</small></h5>
                  </li>
                  <li class="list-group-item">
      ...
      <!-- 
        <div class="b-example-divider"></div>
        -->
      <div class="container px-4 py-5" id="featured-3" style="display:none;">
        <h2 class="pb-2 border-bottom text-center">3 BONUS MENARIK</h2>
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
          <div class="feature col">
            ...
            <h3 class="fs-2">Affiliate/Komunitas Sistem </h3>
            <p>Bangun bisnis Affiliatemu sendiri dengan pengaturan dan aturan sesuka hatimu</p>
          </div>
          <div class="feature col">
            <img src="https://www.bootstrapdash.com/wp-content/uploads/2020/02/bootstrap-pricing-tables.png" class="w-100 mb-2">
            <h3 class="fs-2">Dropship/Reseller Sistem </h3>
            <p>Bangun pasukan Dropship/Resellermu, dan permudah mereka dengan sistem yang KOMBI sediakan, member makin semangat dan Kamu makin Cuan</p>
          </div>
          <div class="feature col">
            <img src="https://www.bootstrapdash.com/wp-content/uploads/2020/02/bootstrap-pricing-tables.png" class="w-100 mb-2">
          ...
          <div class="col-lg-8">
            ...
            <div class="bd-example-snippet bd-code-snippet">
              <div class="bd-example">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">
                    <h5>❌ Kehilangan data pelanggan</h5>
                  </li>
                  <li class="list-group-item">
                    <h5>❌ Repot dalam membuat Customer List</h5>
                  </li>
                  <li class="list-group-item">
                    <h5>❌ Jualan tetep gitu-gitu aja</h5>
                  </li>
                  <li class="list-group-item">
                    <h5>❌ Ga punya Kolam Uang</h5>
                  </li>
                  <li class="list-group-item">
      ...
      <div class="container px-4 py-5">
        ...
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
          <div class="d-flex flex-column align-items-start gap-2">
            ...
            <h3 class="fw-bold mt-4">Sekarang Jangan di Bayangkan</h3>
            <h4 class="warning-notted c-black">Sekarang jangan berandai-andai atau membayangkan tapi ini kenyataan yang akan kamu rasakan</h4>
          </div>
      ...
      <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3 justify-content-center">
        <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
          ...
          <div class="shadow-sm mx-auto">
            <img src="https://duniaundercover.files.wordpress.com/2023/03/kombi-phone.png">
          </div>
        </div>
    ...
    <script>
      function scrollto(){
        var element = document.getElementById("sikat");
